...
use app\models\ObservationsSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * ObservationsController implements the CRUD actions for Observations model.
 */
class ObservationsController extends _AdminController
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        if (($model = Observations::findOne($id)) !== null) {
            return $model;
        }
